var htmx = (() => {
  ...
  function d(e) {
    ...
    let t = Number.NaN;
    if (e.slice(-2) == "ms") {
      t = Number.parseFloat(e.slice(0, -2));
    } else if (e.slice(-1) == "s") {
      t = Number.parseFloat(e.slice(0, -1)) * 1e3;
    } else if (e.slice(-1) == "m") {
      t = Number.parseFloat(e.slice(0, -1)) * 1e3 * 60;
    } else {
  ...
  function yt() {
    if (!xt) {
      ...
      setInterval(() => {
        if (mt) {
          mt = false;
          se(ne().querySelectorAll("[hx-trigger*='revealed'],[data-hx-trigger*='revealed']"), (e) => {
            bt(e);
          });
        }
      }, 200);
  ...
  function St(r, e, t, n) {
    if (e.trigger === "revealed") {
      ...
      if (e.threshold) {
        o.threshold = Number.parseFloat(e.threshold);
      }
  ...
  function An(o) {
    return new Proxy(o, {
      ...
      getOwnPropertyDescriptor: (e, t) => Reflect.getOwnPropertyDescriptor(Object.fromEntries(e), t),
    });
  }
